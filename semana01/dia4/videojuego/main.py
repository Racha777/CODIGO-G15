...
class Bolita(pygame.sprite.Sprite):
    ...
    def update(self):
        #evitar que la bolita se salga de la pantalla
...
class Paleta(pygame.sprite.Sprite):
    ...
    def update(self,evento):
        #buscar si se prediono la flecha de izquierda
...
while True:
    ...
    #pintar la pantalla
    pantalla.fill(FONDO)
    #dibuijar la bolita en pantalla
